...
import { mediaPublicUrl, ensureProjectFolder } from "../../../../lib/admin/media-storage";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Non-fatal: the folder is also created lazily on first upload.
    console.error(`[admin/projects] failed to pre-create folder for "${slug}":`, err);
  }
